...
$CFG->dbtype    = 'mariadb';                  // 'mariadb', 'mariadb', 'mysqli', 'auroramysql', or 'sqlsrv'
$CFG->dblibrary = 'native';                 // 'native' only at the moment
$CFG->dbhost    = 'mariadb';              // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodle';                 // database name, eg moodle
$CFG->dbuser    = 'moodle';               // your database username
$CFG->dbpass    = 'andysag_db_password';               // your database password
...
$CFG->dboptions = [
    ...
    // 'readonly' => [                      // Set to read-only replica details, to get safe reads
                                            ...
                                            //   Currently supported by mariadb and mysqli variety classes.
...
$CFG->wwwroot = "http://176.123.169.77:8080";
