...
### 0. Задеплоить исправления бэкапа на VPS
```bash
cd /opt/geocore && git pull && docker compose up -d --build backup bot
```
После деплоя автоматические ночные бэкапы в 02:00 заработают.
